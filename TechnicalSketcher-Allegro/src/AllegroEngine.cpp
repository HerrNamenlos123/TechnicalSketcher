...
void AllegroEngine::close() {
	running = false;
	std::cout << "Close flag set" << std::endl;
}

void AllegroEngine::infoMessage(const std::string& str) {
	al_show_native_message_box(display, "Info", str.c_str(), NULL, NULL, ALLEGRO_MESSAGEBOX_OK_CANCEL);
}
