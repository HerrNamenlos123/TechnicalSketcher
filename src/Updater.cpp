...
//	if (b::fs::exists(rootPath + OUTDATED_DIRECTORY)) {
//        b::fs::remove_all(rootPath + OUTDATED_DIRECTORY);
...
//	if (result.getStatus() != sf::Http::Response::Status::Accepted) {
...
//	b::fs::remove_all(rootPath + TEMP_DIRECTORY);
//	b::fs::remove(rootPath + UPDATE_FILENAME);
//}
//
//void RunUpdater() {
//
...
//		//
//		auto exePath = b::folders::get_executable_path();
//		auto installPath = exePath.parent_path();
//		auto rootPath = installPath.parent_path();
//		auto installDir = installPath.filename();
...
//		std::unique_ptr<b::lockfile> lockfile;
//		try {
//			lockfile = std::make_unique<b::lockfile>(rootPath + "lock");
//		}
//		catch (...) {
//			return;
//		}
